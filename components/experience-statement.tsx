...
function ImageSeal({ id }: { id: string }) {
  ...
  return <svg className={styles.seal} viewBox="0 0 126 126" aria-hidden="true" focusable="false">
    ...
    <text className={styles.sealMark} x="63" y="74" textAnchor="middle">is.</text>
  </svg>;
}
  ...
  return <section ref={root} className={styles.root} aria-labelledby="experience-statement-title">
    ...
    <figure className={styles.photo} data-experience-motion="photo">
      <Image
        ...
        alt="Dra. Isabella Sampaio em retrato profissional"
        fill
      ...
      <p className={styles.photoCopy} data-experience-motion="photo-copy">ESCOLHAS<br />QUE VALORIZAM<br />O SEU MELHOR.<span aria-hidden="true" /></p>
      <ImageSeal id={uid} />
    </figure>
    ...
    <blockquote className={styles.quote} data-experience-motion="quote">
      ...
      <div>
        <p>A sua melhor versão<br />começa por aqui.</p>
        <footer><span aria-hidden="true" /><cite>ISABELLA SAMPAIO</cite></footer>
      </div>
    </blockquote>
