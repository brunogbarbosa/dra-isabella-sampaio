  ...
  return <section id="manifesto" className="essence-editorial" ref={root} aria-labelledby="essence-title">
    <div className="essence-stage">
      ...
      <svg className="essence-thread essence-thread-desktop" viewBox="0 0 1440 740" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl`} cx="30%" cy="25%"><stop stopColor="#f8eeee"/><stop offset=".5" stopColor="#c3a15e"/><stop offset="1" stopColor="#642a33"/></radialGradient></defs>
      ...
      <svg className="essence-thread essence-thread-mobile" viewBox="0 0 400 900" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl-mobile`} cx="30%" cy="25%"><stop stopColor="#f8eeee"/><stop offset=".5" stopColor="#c3a15e"/><stop offset="1" stopColor="#642a33"/></radialGradient></defs>
      ...
      <figure className="essence-smile" data-essence-motion="photo">
        <Image src="/images/isabella-sorriso.webp" alt="Dra. Isabella Sampaio sorrindo em um momento espontâneo." fill sizes="(max-width:700px) 180vw, (max-width:1100px) 82vw, 67vw"/>
      </figure>
      ...
      <div className="essence-editorial-copy">
        ...
        <p className="essence-editorial-description" data-essence-motion="fade" data-delay="350">A sua beleza faz parte de quem você é. Cuidar de si é valorizar seus traços, sua expressão e tudo o que torna você única.</p>
